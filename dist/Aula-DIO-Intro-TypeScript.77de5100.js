...
var jquery_1 = __importDefault(require("jquery")); //Importando bibliotecas
...
(0, jquery_1.default)('nobdy').novaFuncao();
...
function addApendiceLista(vetor, valor) {
...
function redirecione(usuario) {
  if ('cargo' in usuario) {//redirecionar para area de adm
  } //redirecionar para area do usuario

}

function redirect(usuario) {
  if (usuario.cargo) {//redirecionar para area de adm
  } //redirecionar para area do usuario
...
//# sourceMappingURL=/Aula-DIO-Intro-TypeScript.77de5100.js.map